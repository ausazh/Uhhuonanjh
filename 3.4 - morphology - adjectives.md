...
Adjectives can be used predicatively by converting them into verbs using the suffix -qo, which derives from the verb qâe (to be / to become).  In this form, they can be used either as participles or as im/perfective verbs in all uses.  
