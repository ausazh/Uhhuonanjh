...
Similar to demonstrative/interrogative pronouns above, quantifiers can also be used as *indefinite pronouns*.  Using the appropriate class form, they also inflect for case and number.  Numbers can also be used, taking on class and case endings.  Some examples are given below.
